...
def test_duplicate_text_views_fail_validation():
    ...
    stat = pd.read_parquet("results/clip/statistical_baseline/homecredit_statistical_vectors.parquet")
...
def test_missing_statistical_view_fails_validation():
    text = pd.read_parquet("results/clip/text_baseline/homecredit_text_embeddings.parquet")
    stat = pd.read_parquet("results/clip/statistical_baseline/homecredit_statistical_vectors.parquet").iloc[1:].copy()
