...
OUTPUT_DIR = Path("results/llm_semantic_rankings")
OUTPUT_PATH = OUTPUT_DIR / "homecredit_full_529_llm_semantic_ranking.csv"
SUMMARY_PATH = OUTPUT_DIR / "homecredit_full_529_llm_semantic_ranking_validation.txt"
